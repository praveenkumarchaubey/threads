...
int main()
{
    ...
    /* Initialising Semaphore To 1, 2nd Arg PSHARED=0,
     * which implies that Semaphore available locally to process*/
    /* So this semaphore is having Process Persistence, and don't initialise again*/
