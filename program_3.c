/* Write a threaded application that accepts n number of file names from command line and creates n threads.
 * Each thread is provided with the file name.
 * Every thread will find the size of the file and inode number of the file and return back the filename, inode number and size of file.
 * In case the file does not exist, the thread will return back the filename and 0,0 for file size and inode number.
 * The main thread will print the threadid, file name, file size and inode number.*/
